...
type GridBodyGraficProps = {
    dataLB?: any; // Ajusta el tipo real según LineBarAreaComposedChar
    data_interior?: any; // Ajusta tipo para TwoLevelPieChart
    data_exterior?: any; // Igual
    exampleData?: { hora: string; consumo: number }[]; // datos para Example
    className?: string;
};
        ...
        <article className={className}>
            <div className="grid grid-rows-[auto_1fr] gap-4 ">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="p-4 bg-blue-200 rounded-lg">
                        <TwoLevelPieChart data01={DataComponents.data_interior} data02={DataComponents.data_exterior} />
                    </div>
                </div>
